...
var PATHS = {
  ...
  javascript: [
    ...
    'assets/javascript/vendor/browser.js',
    'assets/javascript/vendor/jquery.fullPage.min.js',
    'assets/javascript/vendor/jquery.velocity.min.js',
    'assets/javascript/vendor/jquery.ba-throttle-debounce.js',
    // 'assets/javascript/vendor/preloadjs-0.6.2.min.js',
    'assets/javascript/vendor/jquery.blast.min.js',
    'assets/javascript/vendor/jquery.swipebox.min.js',
    'assets/javascript/vendor/jquery.mb.YTPlayer.js',
    'assets/javascript/vendor/jquery.parallax.min.js',
    'assets/javascript/vendor/imagesloaded.pkgd.js',
    'assets/javascript/vendor/isotope.pkgd.js',
    'assets/javascript/vendor/swiper.jquery.min.js',
    'assets/javascript/vendor/smoothscroll.js',
    'assets/javascript/vendor/vegas.js',
    'assets/javascript/vendor/sticky-kit.min.js',
    // 'assets/javascript/vendor/jquery.ba-throttle-debounce.js',
...
gulp.task('sass', function() {
  ...
  return gulp.src('assets/scss/mauna.scss')
...
gulp.task('build', ['clean'], function(done) {
  sequence('copy',
          ['sass', 'sassAdmin', 'javascript', 'lint'],
          done);
});
...
gulp.task('clean:css', function() {
  return del([
      'assets/stylesheets/mauna.css',
      'assets/stylesheets/mauna.css.map'
    ]);
});
...
gulp.task('default', ['build', 'browser-sync'], function() {
  ...
  // Sass Watch
  gulp.watch(['assets/scss/**/*.scss'], ['clean:css', 'sass', 'sassAdmin'])
