...
if ( ! class_exists( 'Mauna_protocol_relative_theme_assets' ) ) :
	class Mauna_protocol_relative_theme_assets {
		/**
	...
	$mauna_protocol_relative_theme_assets = new Mauna_protocol_relative_theme_assets;
endif;
