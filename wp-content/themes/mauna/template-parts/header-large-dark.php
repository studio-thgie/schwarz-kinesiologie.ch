<?php
	...
	$logo = isset($redux['mauna_header_dark_logo_large']) ? $redux['mauna_header_dark_logo_large'] : '';
	if(isset($logo['url'])) {
		$logo = $logo['url'];
	}
?>

<div class="navbar-top navbar-top-dark navbar-large navbar-large-dark nav-large-dark">
	<div class="row">
