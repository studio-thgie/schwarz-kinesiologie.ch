<?php
	...
	$logo = isset($redux['mauna_header_light_logo_large']) ? $redux['mauna_header_light_logo_large'] : '';
	if(isset($logo['url'])) {
		$logo = $logo['url'];
	}
?>

<div class="navbar-top navbar-top-light navbar-large navbar-large-light nav-large-light">
	<div class="row">
